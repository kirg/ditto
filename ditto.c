...
struct List *   ditto_buckets_list; /* list of list-of-files that are _ditto_ */
...
wprintf(L"\rdittoing bucket #%d [size=%I64d, count=%d] offs=%I64d          ", i, size, fzbucket->files->count, offs);
